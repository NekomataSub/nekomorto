...
const DashboardProjectsEditor = () => {
  ...
  const typeOptions = useMemo(() => {
    ...
    const sorted = unique.sort((a, b) => comparePtBrVariant(a, b));
    return ["Todos", ...sorted];
  }, [activeProjects]);
  const formatSelectOptions = useMemo(() => {
    ...
    return merged.sort((a, b) => comparePtBrVariant(a, b));
  ...
  const sortedProjects = useMemo(() => {
    ...
    if (sortMode === "alpha") {
      next.sort((a, b) => comparePtBrVariant(a.title, b.title));
      return next;
    }
    if (sortMode === "status") {
      next.sort((a, b) => comparePtBrVariant(a.status, b.status));
      return next;
    }
    if (sortMode === "views") {
