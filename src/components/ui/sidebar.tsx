      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            overlayClassName="top-19"
            className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
                "--sidebar-width": SIDEBAR_WIDTH_MOBILE,
                top: SIDEBAR_MOBILE_HEADER_HEIGHT,
                height: `calc(100svh - ${SIDEBAR_MOBILE_HEADER_HEIGHT})`,
              } as React.CSSProperties
            }
            side={side}
          >
            ...
            <SheetDescription className="sr-only">
              Main navigation menu for mobile screens.
            </SheetDescription>
...
>(
  (
    ...
    const shouldRenderTooltip = Boolean(tooltip) && !isMobile && state === "collapsed";
