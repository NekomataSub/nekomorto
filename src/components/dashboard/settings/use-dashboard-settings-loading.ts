    ...
    const load = async () => {
      ...
      try {
        ...
        if (projectsRes.ok) {
          ...
          nextKnownTags = Array.from(tags).sort((a, b) => compareEnVariant(a, b));
          nextKnownGenres = Array.from(genres).sort((a, b) => compareEnVariant(a, b));
          nextKnownStaffRoles = Array.from(staffRoles).sort((a, b) => compareEnVariant(a, b));
        }
