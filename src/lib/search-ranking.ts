...
const PT_BR_COLLATOR_VARIANT = new Intl.Collator("pt-BR", { sensitivity: "variant" });
const EN_COLLATOR_VARIANT = new Intl.Collator("en", { sensitivity: "variant" });
...
export const comparePtBrVariant = (a: string, b: string): number =>
  PT_BR_COLLATOR_VARIANT.compare(String(a || ""), String(b || ""));

export const compareEnVariant = (a: string, b: string): number =>
  EN_COLLATOR_VARIANT.compare(String(a || ""), String(b || ""));
